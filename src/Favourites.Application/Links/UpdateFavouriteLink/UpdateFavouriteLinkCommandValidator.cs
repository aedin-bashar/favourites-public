...
public sealed class UpdateFavouriteLinkCommandValidator : AbstractValidator<UpdateFavouriteLinkCommand>
{
    private readonly IFavouritesDbContext _dbContext;
    private readonly ICurrentUser _currentUser;

    public UpdateFavouriteLinkCommandValidator(
        ...
        ICurrentUser currentUser)
    {
        ...
        RuleFor(command => command.Id)
            .NotEqual(Guid.Empty).WithMessage("Link id is required.");
