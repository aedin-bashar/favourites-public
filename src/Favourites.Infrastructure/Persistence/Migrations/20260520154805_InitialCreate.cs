    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FavouriteLinkId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TagId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LinkTags", x => new { x.FavouriteLinkId, x.TagId });
                    table.ForeignKey(
                        name: "FK_LinkTags_Links_FavouriteLinkId",
                        column: x => x.FavouriteLinkId,
